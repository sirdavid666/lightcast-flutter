  ...
  Widget build(BuildContext context) {
    ...
    return PanelShell(
      children: [
        ...
        const SizedBox(height: 10),
        _ToggleAction(
          label: 'Show lyrics in Program',
          value: state.programScene.layers.firstWhere((l) => l.kind == LayerKind.lyrics).visible,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return PanelShell(
      children: [
        ...
        const SizedBox(height: 10),
        _ToggleAction(
          label: 'Show scripture in Program',
          value: state.programScene.layers.firstWhere((l) => l.kind == LayerKind.scripture).visible,
    ...
    return PanelShell(
      children: [
        ...
        TextFormField(
          controller: _controller,
          maxLines: 2,
          decoration: const InputDecoration(labelText: 'Text sent directly to Program'),
          onChanged: controller.setTickerText,
        ),
        const SizedBox(height: 10),
        _ToggleAction(
          label: 'Show ticker in Program',
          value: state.programScene.layers.firstWhere((l) => l.kind == LayerKind.ticker).visible,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return PanelShell(
      children: [
        ...
        _ToggleAction(
          label: 'Show logo in Program',
          value: state.programScene.layers.firstWhere((l) => l.kind == LayerKind.logo).visible,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return PanelShell(
      children: [
        ...
        const SizedBox(height: 8),
        _ToggleAction(
          label: 'Show lower third in Program',
          value: state.programScene.layers.firstWhere((l) => l.kind == LayerKind.lowerThird).visible,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return PanelShell(
      children: [
        ...
        _ToggleAction(
          label: 'Show countdown in Program',
          value: state.programScene.layers.firstWhere((l) => l.kind == LayerKind.countdown).visible,
