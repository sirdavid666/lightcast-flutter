  ...
  Widget build(BuildContext context) {
    switch (layer.kind) {
      ...
      case LayerKind.crowdVideo:
        return const _MockFeed(
          label: 'CROWD CAMERA',
          color: Color(0xFF49301C),
        );

      case LayerKind.ticker:
        return _TickerOverlay(
      ...
      case LayerKind.lowerThird:
        final name =
            layer.payload['name'] as String? ?? 'Pastor David';
        final title =
            layer.payload['title'] as String? ?? 'Senior Pastor';
      ...
      case LayerKind.countdown:
        final seconds =
            layer.payload['seconds'] as int? ?? 600;
